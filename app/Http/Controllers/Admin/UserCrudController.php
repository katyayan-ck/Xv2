...
use Backpack\CRUD\app\Http\Controllers\CrudController;  // Yeh wapas laga do
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Facades\Log;

class UserCrudController extends CrudController  // Directly CrudController se extend
{
    ...
    public function setup(): void
    {
        ...
        // Allow all operations (permission checks aap manually laga sakte ho agar chahiye)
