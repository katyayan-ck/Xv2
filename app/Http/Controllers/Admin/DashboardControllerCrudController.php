...
class DashboardControllerCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\DashboardController::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/dashboard-controller');
        CRUD::setEntityNameStrings('dashboard controller', 'dashboard controllers');
    }
